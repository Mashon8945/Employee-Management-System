...
<head>
    ...
    <script src="https://kit.fontawesome.com/9faefacc04.js" crossorigin="anonymous"></script>
...
<body class="fix-header fix-sidebar card-no-border mini-sidebar">
    <div class="preloader" style="display: none; position: fixed;">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li>
                                        ...
                                        ?>
                                        <a href="<?php echo $profile_url;?>"><i class="ti-user"></i> My Profile</a>
                                    </li>
                                    <li>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i><span class="hide-menu">Attendance </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="add_attendance.php">Approve Attendance </a></li>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-off"></i><span class="hide-menu">Leave </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="leave_approval.php"> Leave Application </a></li>
                                    <li><a href="leavetypes.php"> Leave Type</a></li>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Payroll </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="generate_payroll_list.php"> Generate Payslip</a></li>
                                    <li><a href="payroll_report.php"> Payslip Report</a></li>
                                </ul>
                            </li>
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-cash"></i><span class="hide-menu">Salary Advance </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="add_salary.php"> Add Salary Cap </a></li>
                                    <li><a href="grant_advance.php"> Grant Advance </a></li>
                                    <li><a href="pending_advance.php">Existing Advance</a></li>
                                </ul>
                            </li>
                            <li> <a href="#" class="has-arrow waves-effect waves-dark"><i class="mdi mdi-clipboard"></i><span class="hide-menu">Notice <span class="hide-menu"></span></span></a>
                               <ul aria-expanded="false" class="collapse">
                                    <li><a href="notice.php"> New Notice </a></li>
                                </ul>
                            </li>
                         </ul>          
                    </nav>
